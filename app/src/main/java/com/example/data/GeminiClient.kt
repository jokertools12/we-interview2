...
object GeminiClient {
    ...
    suspend fun generateCustomExam(
        ...
        val systemInstruction = "أنت أستاذ هندسة اتصالات وخبير مقابلات فنية في الشركة المصرية للاتصالات Telecom Egypt (WE). ولديك المهارة العالية لتحليل ملفات الـ PDF وصور الشروحات التقنية واستخراج أسئلة دقيقة وعشوائية فريدة واحترافية تلائم المقابلات الحقيقية دون أي تكرار. يجب عليك توليد الأسئلة بشكل ثنائي اللغة (Bilingual) بملء حقول الإنجليزية والعربية معاً بدقة بالغة."
        ...
        val prompt = """
            بناءً على المرجع أو الصور والمواد الهندسية المترابطة أدناه، قم بتوليد $numberOfQuestions أسئلة اختيار من متعدد (MCQs) جديدة تماماً ومحترفة للغاية للتدريب الهندسي لمقابلات المصرية للاتصالات.
            ...
            1. كل سؤال يحتوي على حقول: 
               ...
               - "explanation": (تبرير تفصيلي كامل باللغة العربية لحل السؤال)
               - "category": (إما "Fiber" أو "CCNA" أو "Power" حسب مضمون السؤال)
               - "englishText": (نص السؤال المترجم والمصاغ بأفضل لغة تقنية إنجليزية فنية)
               - "englishOptions": (مصفوفة من 4 خيارات باللغة الإنجليزية متوافقة بنفس الترتيب والمؤشر)
            ...
            [
              {
                ...
                "englishExplanation": "The technical mechanical explanation in English."
              }
            ]
        """.trimIndent()
